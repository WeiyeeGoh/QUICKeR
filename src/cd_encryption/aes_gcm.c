                ...
                uint8_t *plaintext)
{
   ...
   /*
    ...
    // // NOTE: Temporary Code to bypass the Verification From below. Should proably use AE_ENCRYPT and AE_DECRYPT instead of gcm_encrypt and gcm_decrypt
    // EVP_CIPHER_CTX_free(ctx);
    // plaintext_len = len - 16 - iv_len;
